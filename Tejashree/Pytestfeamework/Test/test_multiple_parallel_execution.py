...
env = 'Prod'
# test_multiple_parallel_execution.py
@pytest.mark.skip
@pytest.mark.smoke
...
def test_product_values_11():
    sum = 1
    for i in range(1, 11):
        sum = sum * i
    assert sum >= 50

def test_product_values_12():
    sum = 1
    for i in range(1, 11):
        sum = sum * i
    assert sum >= 50

def test_product_values_13():
    sum = 1
    for i in range(1, 11):
        sum = sum * i
    assert sum >= 50
def test_product_values_14():
    sum = 1
    for i in range(1, 11):
        sum = sum * i
    assert sum >= 50

def test_product_values_15():
    sum = 1
    for i in range(1, 11):
        sum = sum * i
    assert sum >= 50
