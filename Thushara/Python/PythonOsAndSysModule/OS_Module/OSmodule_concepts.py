...
print("Current path : ", current_path) # C:\Projects\GrotechMinds\GTM_PS_Batch03\Thushara\OS_Module
# Change working directory path
os.chdir(r"C:\Projects\GrotechMinds\GTM_PS_Batch03\Thushara\Assignments_batch_03\stfile_handling11_20")

cd = os.getcwd()
print(cd) #C:\Projects\GrotechMinds\GTM_PS_Batch03\Thushara\Assignments_batch_03\stfile_handling11_20

# Get list of all files and folder from target location
target_path = r"C:\Projects\GrotechMinds\GTM_PS_Batch03\Thushara\Assignments_batch_03\stfile_handling11_20"
folder_file_list = os.listdir((target_path))
print(folder_file_list) #['changed_to_uppercase.txt', 'happy2.txt', 'ReadContent.txt', 'sort_content.txt', 'stfile_handling11_15.py']
