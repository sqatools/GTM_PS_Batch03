...
set_h = {5, 7, 3, 88, 22}
val = set_h.remove(88) # doesn't return any value
print("removed value :", val)  # None
print("update set :", set_h)   # {3, 5, 22, 7}

# If we try to remove unavailable data from set, it will throw an error.
...
# If we try to remove any available data, then it does not throw any error.
set_g.discard(100)
print("set_g :", set_g)
