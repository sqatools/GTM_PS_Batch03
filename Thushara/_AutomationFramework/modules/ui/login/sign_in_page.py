...
class LoginPage(SeleniumBase):
    ...
    def click_signin_options(self):
        self.click_element(log_in_options)

    def move_to_sign_out(self):
        self.move_to_third_element(account_locator, wishlist_locator, sign_out)
...
""""
    def move_to_sign_out(self):
        self.move_to_third_element(log_in_options,account_locator,wishlist_locator,sign_out)
"""