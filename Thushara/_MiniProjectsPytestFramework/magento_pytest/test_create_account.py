...
def test_create_account_with_required_fields():
    driver.find_element(By.XPATH,
                        "//a[@href='https://magento.softwaretestingboard.com/customer/account/create/']").click()
...
def test_create_account_with_different_confirmation_password():
    driver.find_element(By.XPATH,
                        "//a[@href='https://magento.softwaretestingboard.com/customer/account/create/']").click()
    driver.find_element(By.CSS_SELECTOR, "input#firstname").send_keys("Alaya")
    driver.find_element(By.CSS_SELECTOR, "input#lastname").send_keys("Latta")
...
@pytest.mark.smoke
def test_create_account_without_required_fields():
    driver.find_element(By.XPATH,
                        "//a[@href='https://magento.softwaretestingboard.com/customer/account/create/']").click()
